...
function renderPatientInfo() {
 ...
 <button class="btn btn-secondary btn-sm" onclick="openEditPatientModal()">Редактировать
 </button>
 <button class="btn btn-danger btn-sm" onclick="confirmDeletePatient()">Удалить
 </button>
 </div>
 </div>
 `;
